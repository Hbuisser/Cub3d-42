...
/*   Updated: 2020/02/15 16:08:02 by hbuisser         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void sprites_raycasting(t_index *idx)
{
    ...
    while (i < idx->spr->numSprites)
    {
        ...
        idx->spr->spriteY = idx->spr->x - idx->parse->posY;
        ...
        {
            idx->spr->texX = (int)(256 * (idx->spr->stripe - (-idx->spr->sprWidth / 2 + idx->spr->spriteScreenX)) * idx->tex->texWidth / idx->spr->sprWidth) / 128;
            if (idx->spr->transformY > 0 && idx->spr->stripe > 0 && idx->spr->stripe < idx->el->resolution_x)
            {
